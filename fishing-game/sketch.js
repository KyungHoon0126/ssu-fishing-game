...
class Fish {
  ...
  static bySeason(season) {
    const table = {
      SPRING: [
        ["벚꽃멸치", 12, [255,127,80], 1.6, 5], //코랄핑크
        ["청연어", 14, [255,241,118], 1.8, 8], //버터옐로우
        ["벚꽃돔", 16, [139,195,74], 2.0, 10], //프레시그린
        ["분홍농어", 20, [255,204,188], 1.5, 15], //피치
        ["벚해삼", 24, [135,206,235], 1.2, 25], //스카이블루
      ],
      SUMMER: [
        ["노랑망둥어", 12, [255,82,82], 2.0, 5], //라벤더
        ["은갈치", 15, [255,255,255], 2.2, 8], //화이트
        ["파랑숭어", 18, [0,71,171], 2.4, 12], //코발트블루 
        ["황금참돔", 22, [230,230,250], 2.0, 15], //워터멜론레드
        ["해태", 26, [64,224,208], 1.8, 25], //민트
      ],
      AUTUMN: [
        ["주홍전갱이", 12, [165,42,42], 1.5, 5], //브릭레드
        ["가을도미", 16, [255,173,1], 1.6, 8], //머스타드
        ["단풍고등어", 20, [85,107,47], 1.8, 12], //올리브그린
        ["낙엽농어", 22, [193,154,107], 1.5, 15], //카멜베이지
        ["붉은장어", 26, [93,64,55], 1.3, 25], //초콜릿브라운
      ],
      WINTER: [
        ["빙어", 12, [54,69,79], 1.4, 5], //차콜그레이
        ["눈송장어", 15, [128,0,32], 1.5, 8], //버건디
        ["얼음방어", 18, [65,105,225], 1.6, 12], //로얄블루
        ["설돔", 22, [192,192,192], 1.3, 15], //스노우실버
        ["혹한가자미", 26, [1,121,111], 1.2, 25], //파인그린
      ],
    }[season];
